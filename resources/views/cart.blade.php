                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img src="{{asset($prd->model->image)}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                            </a>
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{route('cart.dec',['id'=>$prd->rowId,'qty'=>$prd->qty])}}" class="quantity-minus">-</a>
                                            <input title="Qty" value="{{$prd->qty}}" class="email input-text qty text" type="text" placeholder="1" readonly>
                                            <a href="{{route('cart.inc',['id'=>$prd->rowId,'qty'=>$prd->qty])}}" class="quantity-plus">+</a>
                                        </div>
